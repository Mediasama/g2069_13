...
GMItem["g2069/添加技能buff"] = GM:inputStr(function(self, value)
...
GMItem["g2069/移除技能buff"] = GM:inputStr(function(self, value)
    if not World.cfg.openGM then
        return
    end
    local packet = {
...
--GMItem["g2069/pk模式"] = GM:inputStr(function(self, value)
--    if not World.cfg.openGM then
--        return
--    end
