...
--GMItem["g2069/复活特效"] = function(self)
--    self:addBuff("myplugin/revive_effect_buff", 20)
--end

GMItem["g2069/跳跃次数"] = GM:inputStr(function(self, value)
...
GMItem["g2069/创建测试怪物"] = function(self)
    if not World.cfg.openGM then
        return
    end
...
GMItem["g2069/targetPos测试"] = function(self)
    if not World.cfg.openGM then
        return
    end
    ---@type MonsterBornHelper
...
GMItem["g2069/测试怪死亡"] = function(self)
    if not World.cfg.openGM then
        return
    end
    ---@type MonsterBornHelper
