...
local contentText = {
    ...
    "dcasdf萨达阿打算暗示阿萨德阿萨德签完到去玩当前无法无定法水电费水电费水电费水电费沙发上大声道阿萨德阿萨德爱仕达多",
    "asdadwwe12312312412",
    "asdfsdfsdmiwadawdwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwqweqw"
}
local sendIndex = 0
GMItem["聊天插件/10帧一条世界消息"] = function(self, val)
    ...
    self.gmAutoSendMsgTimer = World.Timer(20, function()
        local ChatHelper = T(Lib, "ChatHelper")
